// Kathirvel R Portfolio JavaScript - Complete Working Version
    ...
    sections.forEach(section => {
      ...
      if (scrollPos >= sectionTop && scrollPos < sectionBottom) {
        ...
        document.querySelectorAll('.nav-link').forEach(link => {
          link.classList.remove('text-emerald-600', 'active');
        ...
        if (activeLink) {
          ...
          activeLink.classList.add('text-emerald-600', 'active');
        }
      }
    });
  }
